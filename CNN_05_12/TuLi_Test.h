...
namespace tinyDNN
{
  void tuli_Conv_1()
  {
    ...
    std::shared_ptr<LayerQL<double>> pool_01 = std::make_shared<PooLayerQL<double>>(Pool_Layer, 64, 64); //�ػ���
    std::shared_ptr<Inter_LayerQL<double>> o_01 = in_01 + pool_01;

    //						����			��������			����			����				�����˿���		�����˼�Ƭ		�������
    std::shared_ptr<LayerQL<double>> conv_01 = std::make_shared<Conv_LayerQL<double>>(Conv_Layer, 32, 64, 64, 7, 1, 3); //������
    ...
    std::shared_ptr<LayerQL<double>> pool_02 = std::make_shared<PooLayerQL<double>>(Pool_Layer, 32, 32); //�ػ���
    std::shared_ptr<Inter_LayerQL<double>> o_04 = o_03 + pool_02;

    //						����			��������			����			����				�����˿���		�����˼�Ƭ		�������
    std::shared_ptr<LayerQL<double>> conv_02 = std::make_shared<Conv_LayerQL<double>>(Conv_Layer, 32, 32, 32, 5, 32, 2); //������
    ...
    std::shared_ptr<LayerQL<double>> pool_03 = std::make_shared<PooLayerQL<double>>(Pool_Layer, 16, 16); //�ػ���
    std::shared_ptr<Inter_LayerQL<double>> o_07 = o_06 + pool_03;

    //						����			��������			����			����				�����˿���		�����˼�Ƭ		�������
    std::shared_ptr<LayerQL<double>> conv_03 = std::make_shared<Conv_LayerQL<double>>(Conv_Layer, 16, 16, 16, 3, 32, 1); //������
    std::shared_ptr<Inter_LayerQL<double>> o_08 = o_07 + conv_03;

    std::shared_ptr<LayerQL<double>> rule_03 = std::make_shared<Relu_LayerQL<double>>(Relu_Conv_Layer); //Relu��
    std::shared_ptr<Inter_LayerQL<double>> o_09 = o_08 + rule_03;

    std::shared_ptr<LayerQL<double>> pool_04 = std::make_shared<PooLayerQL<double>>(Pool_Layer, 8, 8); //�ػ���
    ...
    std::shared_ptr<LayerQL<double>> fullconnect_01 = std::make_shared<Fullconnect_LayerQL<double>>(Fullconnect_Layer, 16 * 8 * 8, 30); //ȫ���Ӳ�
    ...
    std::shared_ptr<LayerQL<double>> fullconnect_02 = std::make_shared<Fullconnect_LayerQL<double>>(Fullconnect_Layer, 30, 3); //ȫ���Ӳ�
    std::shared_ptr<Inter_LayerQL<double>> o_14 = o_13 + fullconnect_02;

    std::shared_ptr<LayerQL<double>> rule_05 = std::make_shared<Relu_LayerQL<double>>(Relu_Layer); //Relu��
